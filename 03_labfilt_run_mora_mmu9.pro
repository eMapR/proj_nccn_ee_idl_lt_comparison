...
in_path              = '/vol/v1/proj/nccn/gee_idl_lt_compare/raster/mora/'
out_path             = in_path+'label_v01_mmu9/'
min_year             = 1984
max_year             = 2012
...
label_codes = ['3#greatest_fast_disturbance#Y#GDXX0000L04X00#XXXX0000X00X00,         1, 0, 9, 9, 0, 4']
